...
export const MASTER_SCHEDULE_NOTE =
  ...
  'ช่วงการแข่งขันเริ่มตั้งแต่วันที่ 1 ตุลาคม 2569 เป็นต้นไป (ตามตารางต้นฉบับ) ' +
...
/** วันแรกของช่วงการแข่งขันทั้งหมดตามตารางต้นฉบับ (คอลัมน์แรกของตารางหลัก = 1 ต.ค. 2569) — ไม่ได้แปลว่ามีการแข่งวันนี้เอง แค่เป็นจุดเริ่มต้นของช่วง */
export const EVENT_PERIOD_START: { month: 10 | 11; day: number } = { month: 10, day: 1 }
