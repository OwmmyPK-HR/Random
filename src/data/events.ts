...
export const EVENTS: SportEvent[] = [
  ...
  // 6. แบดมินตัน
  e('6.1', 'แบดมินตัน', 'ชายคู่ทั่วไป', 'ชาย', 'pair', 'bracket', 'อายุ 20 ปีขึ้นไป'),
  e('6.2', 'แบดมินตัน', 'หญิงคู่ทั่วไป', 'หญิง', 'pair', 'bracket', 'อายุ 20 ปีขึ้นไป'),
  e('6.3', 'แบดมินตัน', 'ชายคู่ทั่วไป', 'ชาย', 'pair', 'bracket', 'อายุ 40 ปีขึ้นไป'),
  e('6.4', 'แบดมินตัน', 'หญิงคู่ทั่วไป', 'หญิง', 'pair', 'bracket', 'อายุ 40 ปีขึ้นไป'),
  e('6.5', 'แบดมินตัน', 'ชายคู่ทั่วไป', 'ชาย', 'pair', 'bracket', 'อายุ 50 ปีขึ้นไป'),
  e('6.6', 'แบดมินตัน', 'หญิงคู่ทั่วไป', 'หญิง', 'pair', 'bracket', 'อายุ 50 ปีขึ้นไป'),
  e('6.7', 'แบดมินตัน', 'คู่ผสม', 'ผสม', 'pairMixed', 'bracket', 'อายุ 20 ปีขึ้นไป'),
  e('6.8', 'แบดมินตัน', 'คู่ผสม', 'ผสม', 'pairMixed', 'bracket', 'อายุ 40 ปีขึ้นไป'),
  e('6.9', 'แบดมินตัน', 'คู่ผสม', 'ผสม', 'pairMixed', 'bracket', 'อายุ 50 ปีขึ้นไป'),

  // 7. เปตอง
  e('7.1', 'เปตอง', 'ชายเดี่ยวทั่วไป', 'ชาย', 'individual', 'bracket'),
  e('7.2', 'เปตอง', 'หญิงเดี่ยวทั่วไป', 'หญิง', 'individual', 'bracket'),
  e('7.3', 'เปตอง', 'ชายคู่ทั่วไป', 'ชาย', 'pair', 'bracket'),
  e('7.4', 'เปตอง', 'หญิงคู่ทั่วไป', 'หญิง', 'pair', 'bracket'),
  e('7.5', 'เปตอง', 'คู่ผสมทั่วไป', 'ผสม', 'pairMixed', 'bracket'),
  e('7.6', 'เปตอง', 'ทีมชาย 3 คนทั่วไป', 'ชาย', 'team3', 'bracket'),
  e('7.7', 'เปตอง', 'ทีมหญิง 3 คนทั่วไป', 'หญิง', 'team3', 'bracket'),
]
